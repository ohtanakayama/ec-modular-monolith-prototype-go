// Internal liveness probe for the gRPC monolith.
// The public REST health endpoint (Step N) will be a separate surface.
...
const file_health_v1_health_proto_rawDesc = "" +
	...
	"\rHealthService\x127\n" +
	"\x04Ping\x12\x16.health.v1.PingRequest\x1a\x17.health.v1.PingResponseB\xb8\x01\n" +
	"\rcom.health.v1B\vHealthProtoP\x01ZUgithub.com/ohtanakayama/ec-modular-monolith-prototype-go/gen/proto/health/v1;healthv1\xa2\x02\x03HXX\xaa\x02\tHealth.V1\xca\x02\tHealth\\V1\xe2\x02\x15Health\\V1\\GPBMetadata\xea\x02\n" +
